...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceLabs/solace-product-download/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceLabs/solace-product-download/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceLabs/solace-product-download/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/solace-product-download) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solace-product-download
```
...
```sh
$ git remote add upstream https://github.com/SolaceLabs/solace-product-download
```
...
In GitHub, send a pull request to `solace-product-download:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/solace-product-download/issues/new) and describe the new functionality.

## <a name="addFeature"></a> **Steps to add a new feature**

* Add your feature source file under bin/newFeature.sh
* Update the DockerFile (if needed) to fetch all required packages
